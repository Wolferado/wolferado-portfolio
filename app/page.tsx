...
export default function Home() {
	...
	return (
		<div className="text-text-50 flex h-80 flex-col items-center">
			<h1 className="m-6 text-6xl font-bold max-md:text-3xl">Aleksey Karelin</h1>
			<img
				className="xs:w-[50%] max-xs:m-6 m-10 w-[20%] rounded-[50%] border-4 border-black max-lg:w-[40%] max-md:w-[50%]"
				src="/Home_img.jpg"
			/>
			...
			<span className="flex flex-row">
				...
				<a
					className="flex place-items-center justify-center rounded-xl border-4 bg-[#1b1f23] p-3 indent-3 text-3xl text-white transition-all duration-500 hover:bg-white hover:text-[#1b1f23] max-md:p-1 max-md:text-lg"
